    ...
    return (
        <Container>
            ...
            <Row className='brand-section'>
                <Col md={3} xs={6}>
                    <div className="brand-section-card card-cascade wider">
                        ...
                        <div className="card-body card-body-cascade text-center pb-0">
                            <h5 className="card-title mb-3 p-2 custom-color"><strong>Top rated professionals</strong></h5>
                ...
                <Col md={3} xs={6}>
                    <div className="brand-section-card card-cascade wider">
                        ...
                        <div className="card-body card-body-cascade text-center pb-0">
                            <h5 className="card-title mb-3 p-2 custom-color"><strong>Same day <br />availability</strong></h5>
                            <p className="card-text mb-4">Book in less than 60 seconds, and even select same day slots. </p>
                        </div>
                    </div>
                </Col>
                ...
                <Col md={3} xs={6}>
                    <div className="brand-section-card card-cascade wider">
                        ...
                        <div className="card-body card-body-cascade text-center pb-0">
                            <h5 className="card-title mb-3 p-2 custom-color"><strong>Top quality value for money</strong></h5>
                            <p className="card-text mb-4">Our professionals are equipped with the best tools and our services.</p>
                        </div>
                    </div>
                </Col>
                ...
                <Col md={3} xs={6}>
                    <div className="brand-section-card card-cascade wider">
                        ...
                        <div className="card-body card-body-cascade text-center pb-0">
                            <h5 className="card-title mb-3 p-2 custom-color"><strong>Super app</strong></h5>
                            <p className="card-text mb-4">Being a Super app means we've got the widest range of home services, so we've got you covered! </p>
                        </div>
                    </div>
                </Col>
            </Row>
